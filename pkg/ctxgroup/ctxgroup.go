...
type Group interface {
	Wait() error
	GoCtx(f func(ctx context.Context) error)
}

// GroupImpl wraps errgroup.
...
// WithContext returns a new GroupImpl and an associated Context derived from ctx.
func WithContext(ctx context.Context) GroupImpl {
...
func (g GroupImpl) Go(f func() error) {
	g.wrapped.Go(f)
}

// GoCtx calls the given function in a new goroutine.
func (g GroupImpl) GoCtx(f func(ctx context.Context) error) {
